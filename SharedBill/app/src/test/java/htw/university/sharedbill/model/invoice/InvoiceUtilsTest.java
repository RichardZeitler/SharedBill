...
/**
 * Unit-Tests für die Klasse {@link InvoiceUtils}.
 *
...
public class InvoiceUtilsTest {
    ...
    public void testSaveFile() throws IOException {
        InvoiceUtils.saveInvoiceToAppStorage(mockContext, invoiceWrapper);
    ...
    public void testLoadFile() throws IOException {
        ...
        List<InvoiceWrapper> loadedInvoices = InvoiceUtils.loadAllInvoices(mockContext);
